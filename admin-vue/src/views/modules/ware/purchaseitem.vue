  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form-item label="仓库">
        <el-select style="width:120px;" v-model="dataForm.stockId" placeholder="请选择仓库" clearable>
    ...
    >
      ...
      <el-table-column prop="stockId" header-align="center" align="center" label="仓库id"></el-table-column>
...
export default {
  ...
  methods: {
    mergeItem() {
      ...
      if (!this.purchaseId) {
        this.$confirm(
          ...
          .then(() => {
            this.$http({
              url: this.$http.adornUrl("/stock/purchase/merge"),
              method: "post",
    ...
    getUnreceivedPurchase() {
      this.$http({
        url: this.$http.adornUrl("/stock/purchase/unreceive/list"),
        method: "get",
    ...
    getDataList() {
      ...
      this.$http({
        url: this.$http.adornUrl("/stock/purchasedetail/list"),
        method: "get",
        params: this.$http.adornParams({
          page: this.pageIndex,
          limit: this.pageSize,
    ...
    deleteHandle(id) {
      ...
      this.$confirm(
        ...
        this.$http({
          url: this.$http.adornUrl("/stock/purchasedetail/delete"),
          method: "post",
