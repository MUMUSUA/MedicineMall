...
public class SeckillSessionController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("sale:seckillsession:list")
    ...
    @RequiresPermissions("sale:seckillsession:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("sale:seckillsession:save")
    ...
    @RequiresPermissions("sale:seckillsession:update")
    ...
    @RequiresPermissions("sale:seckillsession:delete")
