...
import com.example.mall.stock.service.PurchaseDetailService;
...
import com.example.mall.stock.vo.PurchaseItemDoneVo;
...
import com.example.mall.stock.dao.PurchaseDao;
    ...
    public void done(PurchaseDoneVo doneVo) {
        ...
        for (PurchaseItemDoneVo item : items) {
            ...
            if (item.getStatus() == WareConstant.PurchaseDetailStatusEnum.HASERROR.getCode()) {
                ...
                PurchaseDetailEntity entity = purchaseDetailService.getById(item.getItemId());
                stockSkuService.addStock(entity.getSkuId(),entity.getStockId(),entity.getSkuNum());
